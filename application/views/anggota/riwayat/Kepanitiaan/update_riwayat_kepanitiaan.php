			...
			<div class="col-md-9 col-md-offset-1">
				<form class="form-horizontal" id="formRiwayatKepanitiaan" method="post">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input name="tahun_kepanitiaan" class="form-control" id="inputTahunKepanitiaan" required="" type="text" placeholder="Tahun Kepanitiaan" value="<?php echo $riwayat_kepanitiaan->tahun_kepanitiaan; ?>" autocomplete="off" pattern="[0-9]{4,4}" title="Format Tahun : YYYY, contoh : 2016">
						</div>
					</div>
