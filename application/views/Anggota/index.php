					...
					<div class="col-md-9">
						<div class="row">
							<ul class="nav nav-tabs">
							  ...
							  <li><a href="<?php echo site_url('anggota/riwayat/pendidikan/riwayat_pendidikan') ;?>">Pendidikan</a></li>
							  <li ><a href="<?php echo site_url('anggota/riwayat/organisasi') ;?>">Organisasi</a></li>
