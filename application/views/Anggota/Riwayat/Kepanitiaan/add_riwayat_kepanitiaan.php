...
<body>
	<div class="container">
		<div class="page-header">
			<h1>Add Riwayat Kepanitiaan <a href="<?php echo site_url('anggota');?>" class="btn btn-sm btn-success">Kembali ke Dashboard</a></h1>
		</div>
		<!--Start Row -->
		<div class="row">
			<div class="col-md-9 col-md-offset-1">
				<form class="form-horizontal" id="formRiwayatKepanitiaan" method="post">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input name="tahun_kepanitiaan" class="form-control" id="inputTahunKepanitiaan" required="" type="text" placeholder="Tahun Kepanitiaan" value="" autocomplete="off">
						</div>
					</div>
